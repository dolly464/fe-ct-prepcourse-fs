...
function asAmirror(frase) {
   ...
   for (let i = 0; i < array.length; i++) {
      arrayInvertido.push(array[i].split('').reverse().join(''));
   }
...
function deleteAbc(string) {
   ...
   const arrayFiltrado = array.filter((letra) => letra !== 'a' && letra !== 'b' && letra !== 'c');
...
function sortArray(arrayOfStrings) {
   ...
   // Tu código:
   const arrayOrdenado = arrayOfStrings.sort((a, b) => a.length - b.length);
